...
Behavioral pattern ควบคุมว่า object โต้ตอบกันอย่างไรและความรับผิดชอบถูกแบ่งปันกันระหว่างพวกมันอย่างไร โมดูลนี้ต่อยอดโดยตรงจาก *Behavioral Patterns I* โดยยึดเป้าหมายเดียวกัน — ลดการผูกติด (coupling) ระหว่าง object ที่ทำงานร่วมกัน — แล้วนำไปใช้กับปัญหาที่ยากขึ้นห้าข้อ ได้แก่ การกำหนดเส้นทางของ request ผ่านแถวของผู้ที่อาจรับผิดชอบ, การส่งการสื่อสารแบบ many-to-many ทั้งหมดผ่านฮับเดียว, การถ่ายภาพและกู้คืนสถานะ, การแนบ operation ใหม่เข้ากับโครงสร้างที่ตายตัว, และการแปลงภาษาเล็ก ๆ ให้กลายเป็น code ที่ทำงานได้
...
ห้า pattern เหล่านี้ต่อยอดจากรากฐานที่วางไว้ใน *Behavioral Patterns I* หากคุณยังไม่ได้อ่าน ให้เริ่มจาก [โมดูล Behavioral Patterns I](/design-patterns/th/behavioral-essentials/) ก่อน
...
- [Behavioral Patterns I](/design-patterns/th/behavioral-essentials/) แนะนำ Strategy, Observer, Command, State, Template Method, และ Iterator
- ต้นไม้ของ [Composite](/design-patterns/th/structural/) เป็นอินพุต class สิกของ Visitor
