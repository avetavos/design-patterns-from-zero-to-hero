---
title: Interpreter
description: 'แทน grammar เล็ก ๆ ด้วยต้นไม้ของ object แล้วประเมินนิพจน์ที่เขียนด้วยภาษานั้น'
sidebar:
  order: 6
---
...
- [Composite](/design-patterns/th/structural/) อธิบายรูปทรงต้นไม้ที่นิพจน์ของ interpreter ก่อร่างขึ้น นิพจน์แบบ non-terminal คือ composite ของนิพจน์ย่อย
- [Visitor](/design-patterns/th/behavioral-advanced/visitor/) มักเสริม Interpreter แทนที่จะใส่ `interpret` ไว้บนทุกโหนด คุณสามารถย้ายการประเมินผล, การพิมพ์, หรือการปรับให้เหมาะสมไปไว้ใน visitor แยกต่างหากบน syntax tree ได้
...
Interpreter เหมาะกับภาษา *เล็ก ๆ* เมื่อ grammar เริ่มมีกฎลำดับความสำคัญ (precedence) จริงจัง, การกู้คืนจากข้อผิดพลาด, และความต้องการด้านประสิทธิภาพ การสร้าง class ต่อหนึ่งกฎด้วยมือจะกลายเป็นภาระ ณ จุดนั้น จงหยิบ parser generator และตัวประเมินผลเฉพาะกิจมาใช้ และเก็บ pattern นี้ไว้สำหรับกรณีที่เล็กจิ๋วจริง ๆ
</Callout>

export const quiz = [
  {
    q: 'Interpreter pattern แทนอะไรในรูปของลำดับชั้น class?',
    options: [
      'สคีมาของฐานข้อมูล',
