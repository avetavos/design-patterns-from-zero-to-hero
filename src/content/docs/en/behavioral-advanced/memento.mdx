...
- [Command](/design-patterns/en/behavioral-essentials/) and Memento are natural partners for undo: a command can keep a memento of the state it changed and restore it when reversed.
- [Iterator](/design-patterns/en/behavioral-essentials/) can use a memento to capture its position when traversal state must survive outside the iterator.
