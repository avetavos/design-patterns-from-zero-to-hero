...
- [Composite](/design-patterns/en/structural/) trees are the canonical structure a visitor walks; a visitor traverses the composite and applies an operation at each node.
- [Iterator](/design-patterns/en/behavioral-essentials/) can supply the elements to a visitor, separating *how you traverse* from *what you do* at each element.
