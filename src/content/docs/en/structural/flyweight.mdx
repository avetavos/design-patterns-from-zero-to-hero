...
- [Singleton](/design-patterns/en/creational/singleton/) shares exactly one instance; Flyweight shares a small pool of immutable instances keyed by intrinsic state.
- [Factory Method](/design-patterns/en/creational/factory-method/) and the flyweight factory both centralise creation, but the flyweight factory's defining job is to return existing objects rather than always making new ones.
