...
- [Adapter](/design-patterns/en/structural/adapter/) makes two existing interfaces work together after the fact; Bridge is planned from the start to let two hierarchies evolve separately.
- [Abstract Factory](/design-patterns/en/creational/abstract-factory/) can build and pair the right implementor with an abstraction, often used alongside Bridge.
