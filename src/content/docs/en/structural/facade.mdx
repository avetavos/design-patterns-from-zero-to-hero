...
- [Adapter](/design-patterns/en/structural/adapter/) changes one object's interface to match an expected one; Facade invents a brand-new simpler interface over many objects.
- [Abstract Factory](/design-patterns/en/creational/abstract-factory/) can sit behind a facade to create the subsystem objects the facade coordinates.
