...
- [Abstract Factory](/design-patterns/en/creational/abstract-factory/) is often implemented as a Singleton so one factory is shared.
- [Prototype](/design-patterns/en/creational/prototype/) offers the opposite stance — make many copies cheaply rather than share one.
