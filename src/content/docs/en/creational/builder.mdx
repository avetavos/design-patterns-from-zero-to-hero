...
- [Abstract Factory](/design-patterns/en/creational/abstract-factory/) returns a product in one call, whereas Builder constructs it across several steps.
- [Prototype](/design-patterns/en/creational/prototype/) is an alternative when a configured object already exists and you want a copy.
