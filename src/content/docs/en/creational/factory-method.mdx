...
- [Abstract Factory](/design-patterns/en/creational/abstract-factory/) often uses several factory methods together to build a product family.
- [Prototype](/design-patterns/en/creational/prototype/) is an alternative when the new object should copy an existing one rather than be built fresh.
