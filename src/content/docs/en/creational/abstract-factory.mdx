...
- [Factory Method](/design-patterns/en/creational/factory-method/) is the simpler one-product cousin and often implements each method of an Abstract Factory.
- [Singleton](/design-patterns/en/creational/singleton/) frequently holds the chosen factory so one instance is shared app-wide.
