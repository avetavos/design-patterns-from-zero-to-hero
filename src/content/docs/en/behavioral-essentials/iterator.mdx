...
- [Composite](/design-patterns/en/structural/composite/) trees are a natural home for iterators, which can flatten a recursive structure into a linear walk.
- [Template Method](/design-patterns/en/behavioral-essentials/template-method/) often drives traversal of a composite, with the iterator filling in the per-node step.
