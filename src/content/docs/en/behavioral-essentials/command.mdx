...
- [Memento](/design-patterns/en/behavioral-advanced/memento/) is a common partner: instead of computing an inverse, a command can snapshot state with a memento and restore it on undo.
- [Strategy](/design-patterns/en/behavioral-essentials/strategy/) also wraps behaviour in an object, but a strategy is chosen to vary an algorithm, while a command represents a specific deferred request.
