...
- [Mediator](/design-patterns/en/behavioral-advanced/mediator/) also decouples senders from receivers but routes through a central hub rather than direct broadcast.
- [Command](/design-patterns/en/behavioral-essentials/command/) is often the payload an observer receives, turning a notification into an executable action.
