...
- [Strategy](/design-patterns/en/behavioral-essentials/strategy/) achieves variation through composition rather than inheritance; it can swap the whole algorithm at runtime, where Template Method varies fixed steps at subclass time.
- [Factory Method](/design-patterns/en/creational/factory-method/) is often a step *within* a template method — the base algorithm calls an overridable creation step.
